package com.qualitrace.backend.controls.application.assembler;

import com.qualitrace.backend.controls.application.dto.ControlRangeSpecificationResponse;
import com.qualitrace.backend.controls.infrastructure.api.ControlRangeSpecificationController;
