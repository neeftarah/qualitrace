...
public record ControlRangeSpecification(
    ...
    public static ControlRangeSpecification createNew(
            String name,
            String method,
            String unit,
            Double min,
    ...
    public ControlRangeSpecification update(String method, Double min, Double max, ComponentRepository componentRepository) {
        if (method == null || method.trim().isEmpty()) {
            throw new IllegalArgumentException("Control range specification method cannot be null or empty");
        }
        if (min == null) {
    ...
    public ControlRangeSpecification delete(ComponentRepository componentRepository) {
